...
function Navbar() {
    return (
        <>
            <div className='fixed bg-white dark:bg-[#000000]  font-dmSans top-0 z-30 mx-0 mt-0 w-full border-b-2 border-zinc-200 dark:border-none'><nav class="bg-white border-gray-200 dark:bg-gray-900">
                <div class="max-w-screen-xl  ml-10 flex flex-wrap items-center justify-between mx-auto p-4">
                    ...
                    <div class="flex items-center mr-10 md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                        <button type="button" class="flex text-sm bg-gray-800 rounded-full md:me-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom">
                            <span class="sr-only">Open user menu</span>
                            <img class="w-14 h-14 rounded-full" src={userimg} alt="user photo" />
